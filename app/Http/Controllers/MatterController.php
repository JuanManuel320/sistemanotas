...
class MatterController extends Controller
{
    ...
    {
        $materia = new Matter();
        $materia->nombre = $request->nombre; //$codigo = $POST
    ...
    public function update(Request $request, Matter $materia)
    {
        ...
        $materia->version = $request->version;
        $materia->save();
        session()->flash("flash.banner", "Materia creada de manera exitosa");
        return Redirect::route('materias.index');
    }
    ...
    {
        $materia->delete();
        session()->flash("flash.banner", "Materia eliminada de manera exitosa");
        return Redirect::route('materias.index');
    }
}
